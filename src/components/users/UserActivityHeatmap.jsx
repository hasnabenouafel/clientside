...
// Données d'activité des utilisateurs pour chaque jour de la semaine avec différentes tranches horaires
...
const UserActivityHeatmap = () => {
	return (
		<motion.div
			...
			animate={{ opacity: 1, y: 0 }} // Animation une fois affiché
			transition={{ delay: 0.4 }} // Délai avant animation
		>
			<h2 className='text-xl font-semibold text-gray-100 mb-4'>User Activity Heatmap</h2>
			<div style={{ width: "100%", height: 300 }}>
				<ResponsiveContainer>
					{/* Composant BarChart pour afficher les données sous forme de diagramme à barres */}
					<BarChart data={userActivityData}>
						{/* Grille de fond pour améliorer la lisibilité du graphique */}
						<CartesianGrid strokeDasharray='3 3' stroke='#374151' />
						{/* Axe des X pour afficher les jours de la semaine */}
						<XAxis dataKey='name' stroke='#9CA3AF' />
						{/* Axe des Y pour les valeurs d'activité */}
						<YAxis stroke='#9CA3AF' />
						...
						<Legend />
						{/* Barres empilées représentant l'activité pour chaque plage horaire */}
